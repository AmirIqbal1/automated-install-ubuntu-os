...
apt-get install mat2 bleachbit clamtk clamav clamav-daemon curl dconf-editor deluge firefox gufw git gdebi gnome-tweak-tool geany gparted htop libreoffice-calc libreoffice-writer openvpn rkhunter snap snapd synaptic tilix virtualbox vlc unrar wget zip dialog python3-pip python3-setuptools -y
...
#install plex, foliate (ebook reader), nordpass, telegram-desktop, gimp, chromium
